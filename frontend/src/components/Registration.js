        ...
        <div className='container mt-5'>
          <div className='signup-content'>
            <div className='signup-form'>
              ...
              <form className='register-form' id='register-form'>
                ...
                <div className='form-group'>
                  ...
                  <input type='number' name='phone' id='phone' autoComplete='off' placeholder='Your Mobile Number' />
                </div>
                ...
                <div className='form-group'>
                  ...
                  <input type='password' name='cpassword' id='cpassword' autoComplete='off' placeholder='Confirm our Password' />
                </div>
            ...
            <div className='signup-image'>
              ...
              <NavLink to='/login' className='signup-image-link'>Already Registter</NavLink>
            </div>
          </div>
        </div>
